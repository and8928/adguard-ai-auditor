...
const translations = {
    en: {
        ...
        "set.section_llm": "LLM API Keys & Models",
        "set.gemini_key": "Gemini API Key",
        "set.gemini_models": "Gemini models",
        "set.vertex_key": "Vertex AI API Key",
        "set.vertex_models": "Vertex AI models",
        "set.openai_key": "OpenAI API Key",
        "set.openai_model": "OpenAI model",
        "set.deepseek_key": "DeepSeek API Key",
        "set.deepseek_models": "DeepSeek models",
        "set.unsloth_url": "Unsloth base URL",
        "set.unsloth_key": "Unsloth API Key",
        "set.unsloth_models": "Unsloth models",
        "set.unsloth_url_ph": "e.g. http://localhost:8888/v1",
        "set.secret_ph": "••• set (leave empty to keep)",
        "set.models_ph": "comma-separated, tried in order",
        "set.model_ph": "e.g. gpt-5-mini",
        "btn.test_conn": "Test connection",
        "btn.test_login": "Test login",
        "btn.testing": "Testing...",
    ...
    ru: {
        ...
        "set.section_llm": "API-ключи и модели LLM",
        "set.gemini_key": "Gemini API-ключ",
        "set.gemini_models": "Модели Gemini",
        "set.vertex_key": "Vertex AI API-ключ",
        "set.vertex_models": "Модели Vertex AI",
        "set.openai_key": "OpenAI API-ключ",
        "set.openai_model": "Модель OpenAI",
        "set.deepseek_key": "DeepSeek API-ключ",
        "set.deepseek_models": "Модели DeepSeek",
        "set.unsloth_url": "Unsloth base URL",
        "set.unsloth_key": "Unsloth API-ключ",
        "set.unsloth_models": "Модели Unsloth",
        "set.unsloth_url_ph": "напр. http://localhost:8888/v1",
        "set.secret_ph": "••• задано (пусто — не менять)",
        "set.models_ph": "через запятую, по порядку",
        "set.model_ph": "напр. gpt-5-mini",
        "btn.test_conn": "Тест коннект",
        "btn.test_login": "Тест логин",
