...
const translations = {
  en: {
    ...
    "empty.filters": "Click the tab to load current active filter rules.",
  ...
  ru: {
    ...
    "limit.200": "200 записей",
    "limit.500": "500 записей",
    "limit.0": "Все записи",
    ...
    "empty.filters": "Нажмите на вкладку, чтобы загрузить актуальные правила фильтрации.",
