...
from src.adguard_auditor.api.v1.endpoints import audit, prompt_rules, settings as settings_endpoint
...
app.include_router(settings_endpoint.router, prefix="/api/v1")
